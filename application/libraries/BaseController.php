...
class BaseController extends CI_Controller {
	 ...
	 */
	function loadThis() {
		$this->global ['pageTitle'] = 'Mirota KSM : Access Denied';
		
		$this->load->view ( 'adminpanel/includes/header', $this->global );
    ...
    function loadViews($viewName = "", $headerInfo = NULL, $pageInfo = NULL, $footerInfo = NULL){
				...
				// $data['versi'] = $this->master_model->getNewVersion();
	...
	function loadPageViews($viewName = "", $headerInfo = NULL, $pageInfo = NULL, $footerInfo = NULL){
		$this->load->view('includes/header', $headerInfo);
		$this->load->view($viewName, $pageInfo);
		$this->load->view('includes/footer', $footerInfo);
	}
	
	function generateBarcode($kode, $namaqrcode, $id){
		...
		$image_name = $namaqrcode.'.png'; //buat name dari qr code sesuai dengan nim
