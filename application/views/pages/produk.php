<section class="pages produkkami">
    ...
    <section class="info-produk"  data-aos="fade-up" data-aos-duration="1000" data-aos-easing="ease-in-sine">
        <div class="row">
            <div class="col-md-6 gambar-highlight">
                <img src="assets/landingpage/images/nutri.webp" srcset="">
            </div>
            <div class="col-md-6 ">
                <div class="row">
                    <div class="col-md-12 gambar-produk">
                        <!-- <img src="assets/landingpage/images/nutri.png" srcset=""> -->
                    </div>
                    <div class="col-md-12 carousel-produk">
                        <div id="carouselExampleInterval" class="carousel slide" data-bs-ride="carousel">
                            <div class="carousel-inner">
                                <div class="carousel-item carousel-card active"  data-bs-interval="3000">
                                    <div class="card card-kandungan text-center">
                                        <div class="card-header">
                                            <h2 class="myH2 text-center">Tinggi Omega 3 & 6</h2>
                                        </div>
                                        <div class="card-body">
                                            <p class="myP">Omega 3 & 6 berperan dalam mengoptimalkan perkembangan kognitif, aktivitas otot, hingga pertumbuhan fisik si Kecil.</p>
                                        </div>
                                    </div>        
                                </div>
                                <div class="carousel-item carousel-card" data-bs-interval="3000">
                                    <div class="card card-kandungan text-center">
                                        <div class="card-header">
                                        <h2 class="myH2 m-2 text-center">Tinggi Kolin</h2>
                                        </div>
                                        <div class="card-body">
                                            <p class="myP">Kolin berfungsi untuk pembentukan fosfatidilkolin dan penyusun asetilkolin.</p>
                                        </div>
                                    </div>           
                                </div>
                                <div class="carousel-item carousel-card" data-bs-interval="3000">
                                    <div class="card card-kandungan text-center">
                                        <div class="card-header">
                                            <h2 class="myH2 m-2 text-center">Tinggi Protein</h2>
                                            </div>
                                            <div class="card-body">
                                                <p class="myP">Protein diperlukan untuk membangun dan memperbaiki jaringan tubuh.</p>
                                            </div>
                                        </div>           
                                    </div>
                                <div class="carousel-item carousel-card" data-bs-interval="3000">
                                    <div class="card card-kandungan text-center">
                                        <div class="card-header">
                                            <h2 class="myH2 m-2 text-center">Tinggi DHA</h2>
                                            </div>
                                            <div class="card-body">
                                                <p class="myP">DHA berfungsi meningkatkan fungsi kognitif serta pembentukan otak secara menyeluruh pada otak anak.</p>
                                            </div>
                                        </div>           
                                    </div>
                                <div class="carousel-item carousel-card" data-bs-interval="3000">
                                    <div class="card card-kandungan text-center">
                                        <div class="card-header">
                                            <h2 class="myH2 m-2 text-center">Tinggi Biotin</h2>
                                            </div>
                                            <div class="card-body">
                                                <p class="myP">Blotin membantu meningkatkan tingkat metabolisme dalam tubuh.</p>
                                            </div>
                                        </div>           
                                    </div>
                            </div>
    ...
    <section class="produk">
        <div class="container">
            <div class="header-produk" data-aos="fade-up" data-aos-duration="1000" data-aos-easing="ease-in-sine">
                <h2 class="header-text">Produk Kami</h2>
            </div>
