...
<div id="carouselExampleInterval" class="carousel slide d-none d-lg-block" data-bs-ride="carousel">
    <div class="carousel-inner">
        ...
        <img src="<?php echo base_url().'assets/landingpage/images/bannerlandscape1.webp'?>" class="d-block w-100 img-carousel">
        </div>
...
<div id="carouselMobile" class="carousel slide d-block d-lg-none" data-bs-ride="carousel">
  <div class="carousel-inner">
    <div class="carousel-item active" data-bs-interval="3000">
    <img src="<?php echo base_url().'assets/landingpage/images/bannerpotrait1.webp'?>" class="d-block w-100 img-carousel">
    </div>
  </div>
